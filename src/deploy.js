...
exports.initializeCommands = async (client) => {
  ...
  //   await rest.get(Routes.applicationCommands(botconfig.CLIENT_ID)).then((data) => {
  //     const promises = [];
  ...
  await rest
    .put(Routes.applicationGuildCommands(botconfig.CLIENT_ID, botconfig.GUILD_ID), { body: commands })
