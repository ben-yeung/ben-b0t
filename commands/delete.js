...
module.exports = {
    ...
    usage: "?delete [slash command id] [optional: delete guild command? Leave blank if false]",
    async execute(bot, message, args) {
        ...
        let id = args[0]
        try {
            if (botconfig.GUILD_ID && args[1] == 'true') { //args[1] true if Guild Testing Command deletion
